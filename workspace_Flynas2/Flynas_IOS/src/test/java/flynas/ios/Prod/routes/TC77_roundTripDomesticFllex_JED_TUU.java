...
public class TC77_roundTripDomesticFllex_JED_TUU extends BookingPageFlow{
	...
	public  void TC_77_roundTripDomesticFllex_JED_TUU(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC77_roundTripDomesticFllex_JED_TUU", "Pass");
			
			}
		
	catch (Exception e) {
		e.printStackTrace();
			Reporter.failureReport("TC77_roundTripDomesticFllex_JED_TUU", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			xls.getCellValue("Currency", "Value"),
    	    		"Validate RountTrip Domestic Flex_JED_TUU"}};
	}
