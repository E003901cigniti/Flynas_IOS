...
public class TC151_roundTripDomesticBusiness_ABH_BHH extends BookingPageFlow{
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"TestData");

	@Test(dataProvider = "testData",groups={"Business"})
	public  void TC_151_roundTripDomesticBusiness_ABH_BHH(String tripType, String origin, String dest, 
...
//			login(username,password);
			...
			Reporter.SuccessReport("TC151_roundTripDomesticBusiness_ABH_BHH", "Pass");
			
			}
		
	catch (Exception e) {
		e.printStackTrace();
			Reporter.failureReport("TC151_roundTripDomesticBusiness_ABH_BHH", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate RoundTrip Domestic Business_ABH_BHH"}};
	}
