...
public class TC26_roundTripDomesticEconomy_AHB_ABT extends BookingPageFlow{
	...
	public  void TC_26_roundTripDomesticEconomy_AHB_ABT(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC26_roundTripDomesticEconomy_AHB_ABT", "Pass");
			
			}
		
	catch (Exception e) {
		e.printStackTrace();
			Reporter.failureReport("TC26_roundTripDomesticEconomy_AHB_ABT", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			xls.getCellValue("Currency", "Value"),
    	    		"Validate RoundTrip Domestic Economy_AHB_ABT"}};
	}
