...
public class TC89_roundTripDomesticFlex_ABH_BHH extends BookingPageFlow{
	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"TestData");

	@Test(dataProvider = "testData",groups={"Flex"})
	public  void TC_89_roundTripDomesticFlex_ABH_BHH(String tripType, String origin, String dest, 
...
//			login(username,password);
			...
			Reporter.SuccessReport("TC89_roundTripDomesticFlex_ABH_BHH", "Pass");
			
			}
		
	catch (Exception e) {
		e.printStackTrace();
			Reporter.failureReport("TC89_roundTripDomesticFlex_ABH_BHH", "Failed");
		}
	}
