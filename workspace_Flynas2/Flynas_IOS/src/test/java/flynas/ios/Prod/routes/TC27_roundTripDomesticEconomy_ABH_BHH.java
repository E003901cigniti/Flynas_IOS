...
public class TC27_roundTripDomesticEconomy_ABH_BHH extends BookingPageFlow{
	...
	public  void TC_27_roundTripDomesticEconomy_ABH_BHH(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC27_roundTripDomesticEconomy_ABH_BHH", "Pass");
			
			}
		
	catch (Exception e) {
		e.printStackTrace();
			Reporter.failureReport("TC27_roundTripDomesticEconomy_ABH_BHH", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			xls.getCellValue("Currency", "Value"),
    	    		"Validate oneWay Domestic Economy _ABH_BHH"}};
	}
