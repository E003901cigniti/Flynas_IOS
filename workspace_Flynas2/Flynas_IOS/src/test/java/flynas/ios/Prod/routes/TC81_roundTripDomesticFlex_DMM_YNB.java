...
public class TC81_roundTripDomesticFlex_DMM_YNB extends BookingPageFlow{
	...
	public  void TC_81_roundTripDomesticFlex_DMM_YNB(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC81_oundTripDomesticFlex_DMM_YNB", "Pass");
			
			}
		
	catch (Exception e) {
		e.printStackTrace();
			Reporter.failureReport("TC81_oundTripDomesticFlex_DMM_YNB", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			xls.getCellValue("Currency", "Value"),
    	    		"Validate RountTrip Domestic Flex_DMM_YNB"}};
	}
