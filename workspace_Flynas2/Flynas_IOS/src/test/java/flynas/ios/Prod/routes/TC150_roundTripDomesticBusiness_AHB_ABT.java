...
public class TC150_roundTripDomesticBusiness_AHB_ABT extends BookingPageFlow{
	...
	public  void TC_88_roundTripDomesticFlex_AHB_ABT(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC88_roundTripDomesticFlex_AHB_ABT", "Pass");
			
			}
		
	catch (Exception e) {
		e.printStackTrace();
			Reporter.failureReport("TC88_roundTripDomesticFlex_AHB_ABT", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
    			...
    			xls.getCellValue("Currency", "Value"),
    	    		"Validate RoundTrip Domestic Flex_AHB_ABT"}};
	}
