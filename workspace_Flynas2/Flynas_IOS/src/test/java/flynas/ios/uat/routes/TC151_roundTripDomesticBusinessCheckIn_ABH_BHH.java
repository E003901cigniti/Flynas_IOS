...
public class TC151_roundTripDomesticBusinessCheckIn_ABH_BHH extends BookingPageFlow{
	...
	public  void TC_151_roundTripDomesticBusinessCheckIn_ABH_BHH(String tripType, String origin, String dest, 
			...
			String charity,String Currency,String username,String password, String Description) 
			throws Throwable {
		try {
...
//			login(username,password);
			...
			waitForElementPresent(BookingPageLocators.payment_btn, "PaymentBtn");
			click(BookingPageLocators.payment_btn, "PaymentBtn");
			if(isElementDisplayedTemp(BookingPageLocators.continuebtn)){
				click(BookingPageLocators.continuebtn, "Continue");
			}
			validateCheckin();
			Reporter.SuccessReport("TC151_roundTripDomesticBusinessCheckIn_ABH_BHH", "Pass");
			
			}
		
	catch (Exception e) {
		e.printStackTrace();
			Reporter.failureReport("TC151_roundTripDomesticBusinessCheckIn_ABH_BHH", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate RoundTrip Domestic Business CheckIn_ABH_BHH"}};
	}
