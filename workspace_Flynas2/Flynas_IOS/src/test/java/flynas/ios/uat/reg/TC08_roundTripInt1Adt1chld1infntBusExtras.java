...
public class TC08_roundTripInt1Adt1chld1infntBusExtras extends BookingPageFlow{
		
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData"),"TestData");

	@Test(dataProvider = "testData",groups={"ios"})
	public  void TC_08_roundTripInt1Adt1chld1infntBusExtras(String tripType, String origin, String dest,String deptDate,
		...
		try {
			...
			if(isElementDisplayedTemp(BookingPageLocators.seatSelectionTittle)==true){
				click(BookingPageLocators.payment_btn, "Continue to select Payment");
			}
			...
			Reporter.SuccessReport("TC08_roundTripInt1Adt1chld1infntBusExtras", "Pass");

		}

		catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC08_roundTripInt1Adt1chld1infntBusExtras", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
		return (Object[][]) new Object[][] { 
			{xls.getCellValue("Trip Type", "Value2"),
			   ...
			   "Validate roundTrip Intrnational 1 Adult 1 chld 1 infnt Bus Extras"}
			};
	}
