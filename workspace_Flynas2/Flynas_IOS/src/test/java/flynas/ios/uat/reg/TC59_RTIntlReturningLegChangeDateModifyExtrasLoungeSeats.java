...
public class TC59_RTIntlReturningLegChangeDateModifyExtrasLoungeSeats extends BookingPageFlow{
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData_UAT_Reg"),"FL_WEB_35");

	@Test(dataProvider = "testData",groups={"ios"})
	public void TC_59_RTIntlReturningLegChangeDateModifyExtrasLoungeSeats(String tripType, String origin, String dest, 
			...
			payment(paymenttype,"");
					...
					Reporter.SuccessReport("TC_59_RTIntlReturningLegChangeDateModifyExtrasLoungeSeats", "Pass");
					
					}catch(Exception e){
						e.printStackTrace();
						Reporter.failureReport("TC_59_RTIntlReturningLegChangeDateModifyExtrasLoungeSeats", "Fail");
