...
public class TC02_d_RTDomesticBusiness1AdultCC extends BookingPageFlow{
	...
	public  void TC_02_d_RTDomesticBusiness1AdultCC(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC02_d_RTDomesticBusiness1AdultCC", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC02_d_RTDomesticBusiness1AdultCC", "Failed");
		}
	}
