...
public class TC51_RTIntlCancelBothlegVerifyMMB extends BookingPageFlow{
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData_UAT_Reg"),"FL_WEB_35");

	@Test(dataProvider = "testData",groups={"ios"})
	public void TC_51_RTIntlCancelBothlegVerifyMMB(String tripType, String origin, String dest, 
			...
			payment(paymenttype,"");
					...
					Reporter.SuccessReport("TC51_RTIntlCancelBothlegVerifyMMB", "Pass");
					
					}catch(Exception e){
						e.printStackTrace();
						Reporter.failureReport("TC51_RTIntlCancelBothlegVerifyMMB", "Fail");
		...
		public Object[][] createdata1() {
		    return (Object[][]) new Object[][] {{
    			...
    			"Validate International Roundtrip booking, cancellation and verification in MMB"}};
	}
