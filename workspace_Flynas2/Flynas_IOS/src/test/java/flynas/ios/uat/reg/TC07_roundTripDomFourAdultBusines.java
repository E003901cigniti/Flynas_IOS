...
public class TC07_roundTripDomFourAdultBusines extends BookingPageFlow{
	...
	public  void TC_06_oneWayInternatnlTwoAdultEco(String tripType, String origin, String dest,String deptDate,
		...
		try {
			...
			Reporter.SuccessReport("TC07_roundTripDomFourAdultBusines", "Pass");

		}

		catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC07_roundTripDomFourAdultBusines", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
		return (Object[][]) new Object[][] { 
			{xls.getCellValue("Trip Type", "Value2"),
				...
				xls.getCellValue("Adults Count", "Value4"),
				...
				xls.getCellValue("Total Passenger", "Value4"),
			   ...
			   "Validate roundTrip Domestic Four Adult Busines"}
			};
	}
