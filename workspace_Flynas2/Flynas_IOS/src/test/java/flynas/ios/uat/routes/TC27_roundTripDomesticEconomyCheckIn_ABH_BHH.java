...
public class TC27_roundTripDomesticEconomyCheckIn_ABH_BHH extends BookingPageFlow{
	...
	public  void TC_27_roundTripDomesticEconomyCheckIn_ABH_BHH(String tripType, String origin, String dest, 
...
//			login(username,password);
			...
			validateCheckin();
			Reporter.SuccessReport("TC27_roundTripDomesticEconomyCheckIn_ABH_BHH", "Pass");
			
			}
		
	catch (Exception e) {
		e.printStackTrace();
			Reporter.failureReport("TC27_roundTripDomesticEconomyCheckIn_ABH_BHH", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate RoundTrip Domestic Economy CheckIn_ABH_BHH"}};
	}
