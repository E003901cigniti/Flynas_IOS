...
public class TC13_oneWayDomesticSimpleCCUSD extends BookingPageFlow{
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData_UAT_Reg"),"FL_WEB_13");

	@Test(dataProvider = "testData",groups={"ios"})
	public  void TC_13_oneWayDomesticSimpleCCUSD(String tripType, String origin, String dest,String deptDate,String origin2,
		...
		try {
			...
			Reporter.SuccessReport("TC13_oneWayDomesticSimpleCCUSD", "Pass");

		}

		catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC13_oneWayDomesticSimpleCCUSD", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
		return (Object[][]) new Object[][] { 
			{xls.getCellValue("Trip Type", "Value"),xls.getCellValue("Origin", "Value"),xls.getCellValue("Destination", "Value"),
				...
				"Validate one Way Domestic Simple class booking with USD"}
			};
	}
