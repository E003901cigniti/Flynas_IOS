...
public class TC89_roundTripDomesticFlexCheckIn_ABH_BHH extends BookingPageFlow{
	...
	public  void TC_89_roundTripDomesticFlexCheckIn_ABH_BHH(String tripType, String origin, String dest, 
...
//			login(username,password);
			...
			validateCheckin();
			Reporter.SuccessReport("TC89_roundTripDomesticFlexCheckIn_ABH_BHH", "Pass");
			
			}
		
	catch (Exception e) {
		e.printStackTrace();
			Reporter.failureReport("TC89_roundTripDomesticFlexCheckIn_ABH_BHH", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"Validate RoundTrip Domestic Flex CheckIn_ABH_BHH"}};
	}
