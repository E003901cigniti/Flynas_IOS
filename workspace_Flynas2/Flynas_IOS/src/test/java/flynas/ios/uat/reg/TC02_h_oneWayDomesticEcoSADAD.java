...
public class TC02_h_oneWayDomesticEcoSADAD extends BookingPageFlow{
	...
	public  void TC0_2h_oneWayDomesticEcoSADAD(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC02_h_oneWayDomesticEcoSADAD", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC02_h_oneWayDomesticEcoSADAD", "Failed");
		}
	}
