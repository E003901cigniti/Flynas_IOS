...
public class TC58_RTDomesticReturningLegChangeDateModifyExtrasLoungeSeats extends BookingPageFlow{
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData_UAT_Reg"),"FL_WEB_35");

	@Test(dataProvider = "testData",groups={"ios"})
	public void TC_58_RTDomesticReturningLegChangeDateModifyExtrasLoungeSeats(String tripType, String origin, String dest, 
			...
			payment(paymenttype,"");
					...
					Reporter.SuccessReport("TC58_RTDomesticReturningLegChangeDateModifyExtrasLoungeSeats", "Pass");
					
					}catch(Exception e){
						e.printStackTrace();
						Reporter.failureReport("TC58_RTDomesticReturningLegChangeDateModifyExtrasLoungeSeats", "Fail");
