...
public class TC47_RTDomesticCancelDepartingLeg extends BookingPageFlow{
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData_UAT_Reg"),"FL_WEB_35");

	@Test(dataProvider = "testData",groups={"ios"})
	public void TC_47_RTDomesticCancelDepartingLeg(String tripType, String origin, String dest, 
			...
			String charity,String Currency,String Description)throws Throwable{
				try{
					...
					cancelFlights("Departing");
					confirmChanges();
					verifyConfirmchanges();
					
					
					Reporter.SuccessReport("TC47_RTDomesticCancelDepartingLeg", "Pass");
					
					}catch(Exception e){
						e.printStackTrace();
						Reporter.failureReport("TC47_RTDomesticCancelDepartingLeg", "Fail");
		...
		public Object[][] createdata1() {
		    return (Object[][]) new Object[][] {{
    			...
    			"Validate Departing leg cancellation in Domestic Roundtrip"}};
	}
