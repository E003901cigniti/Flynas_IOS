...
public class TC49_RTIntlCancelDepartingLeg extends BookingPageFlow{
	...
	public void TC_49_RTIntlCancelDepartingLeg(String tripType, String origin, String dest, 
			...
			payment(paymenttype,"");
					...
					Reporter.SuccessReport("TC49_RTIntlCancelDepartingLeg", "Pass");
						...
						e.printStackTrace();
						Reporter.failureReport("TC49_RTIntlCancelDepartingLeg", "Fail");
		...
		public Object[][] createdata1() {
		    return (Object[][]) new Object[][] {{
    			...
    			"Validate Departing leg cancellation in International Roundtrip"}};
	}
