...
public class TC02_b_oneWayDomesticBusiness1AdultCC extends BookingPageFlow{
	...
	public  void TC_02_b_oneWayDomesticBusiness1AdultCC(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC02_b_oneWayDomesticBusiness1AdultCC", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			Reporter.failureReport("TC02_b_oneWayDomesticBusiness1AdultCC", "Failed");
		}
	}
	...
	public Object[][] createdata1() {
	    return (Object[][]) new Object[][] { 
	    		...
	    		"",xls.getCellValue("Mobile", "Value"),xls.getCellValue("Email Address", "Value"),xls.getCellValue("Select Seat", "Value2"),
	    		xls.getCellValue("Payment Type", "Value"),"",xls.getCellValue("Charity Donation", "Value"),xls.getCellValue("Currency", "Value"),
	    		"Validate One way Domestic one Adult Business class booking"}};
	}
