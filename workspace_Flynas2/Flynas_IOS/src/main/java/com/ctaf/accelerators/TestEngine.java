	...
	public static void setupSuite(ITestContext ctx) throws Throwable {
		...
		if(browser.equalsIgnoreCase("iphone")){
			try {
				...
				capabilitiesForAppium.setCapability(MobileCapabilityType.PLATFORM_NAME, "iOS");
				capabilitiesForAppium.setCapability(MobileCapabilityType.PLATFORM_VERSION, platformVer);
				capabilitiesForAppium.setCapability(MobileCapabilityType.DEVICE_NAME, device);
				...
				capabilitiesForAppium.setCapability(IOSMobileCapabilityType.WAIT_FOR_APP_SCRIPT, "target.elements().length > 0; $.delay(8000); $.acceptAlert();");
				capabilitiesForAppium.setCapability(IOSMobileCapabilityType.BUNDLE_ID, bundleID);
				//capabilitiesForAppium.setCapability(MobileCapabilityType.AUTO_WEBVIEW, true);
			//	capabilitiesForAppium.setCapability("startIWDP", true);
				capabilitiesForAppium.setCapability("autoDismissAlerts", true);
				//capabilitiesForAppium.setCapability(IOSMobileCapabilityType.AUTO_ACCEPT_ALERTS, true);
...
//			
//				AppiumDriver  Iosdriver = new IOSDriver(new URL("http://127.0.0.1:4723/wd/hub"),
//				capabilitiesForAppium);
			...
			capabilitiesForAppium.setCapability("platformVersion", "9.3.2");
			capabilitiesForAppium.setCapability("browserName", "Safari");
			capabilitiesForAppium.setCapability(MobileCapabilityType.AUTOMATION_NAME, AutomationName.IOS_XCUI_TEST);
			Iosdriver= new IOSDriver (new URL("http://0.0.0.0:4723/wd/hub"),capabilitiesForAppium);
			driver = Iosdriver;
		}
	}
	...
	public static String filePath() {
		...
		if (browser.equalsIgnoreCase("ie")) {
			...
			strDirectoy = "iossafari"+File.separator+"iossafari";
		}
	...
	public void reportHeader(Method method) throws Throwable {
		...
		ReportStampSupport.calculateTestCaseStartTime();
			if (browser.equalsIgnoreCase("firefox")) {
				...
				File pathToBinary = new File("C:\\Users\\E002693\\AppData\\Local\\Mozilla Firefox\\firefox.exe");
